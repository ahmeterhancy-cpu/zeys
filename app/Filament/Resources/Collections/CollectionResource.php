...
class CollectionResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Koleksiyonlar';

    protected static ?string $modelLabel = 'koleksiyon';

    protected static ?string $pluralModelLabel = 'koleksiyonlar';
